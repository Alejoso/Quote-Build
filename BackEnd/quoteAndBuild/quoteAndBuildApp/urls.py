...
from .views import MaterialViewSet, ProjectViewSet, PhaseViewSet,  SupplierViewSet, SupplierMaterialViewSet, SupplierPhoneViewSet, PhaseMaterialViewSet, QuoteViewSet, QuoteItemViewSet, PhaseIntervalViewSet
...
router.register(r'supplier-phones', SupplierPhoneViewSet, basename='supplier-phones')
