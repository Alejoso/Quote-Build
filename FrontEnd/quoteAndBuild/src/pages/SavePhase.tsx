...
// Import fuctions
// import { fetchPhasesByProject} from "../api/calls"; Aún no se está usando
...
export default function savePhase({project} : {project : Project}) {
  ...
  //Definition of the variable phase, that is going to be fulfiled while we are doinpg the forms with the useState
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if(phase.name === ''){
      toast.error("No se le olvide llenar el nombre"); 
    } else {
